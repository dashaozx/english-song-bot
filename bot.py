...
SONGS = [
   ...
   "fragments": [
            {"file": "sh_0.mp4", "text": "The club isn't the best place to find a ___\nSo the bar is where I go", "answer": "lover", "translation_ru": "Клуб — не лучшее место для поиска любви, поэтому я иду в бар."},
            {"file": "sh_1.mp4", "text": "Me and my friends at the table doing ___\nDrinking fast and then we talk slow", "answer": "shots", "translation_ru": "Мы с друзьями за столом пьем шоты. Пьем быстро, говорим медленно."},
            {"file": "sh_2.mp4", "text": "And you come over and start up a conversation with just me\nAnd trust me I'll give it a ___ now", "answer": "chance", "translation_ru": "И ты подходишь и заводишь разговор только со мной. Поверь, я дам этому шанс."},
            {"file": "sh_3.mp4", "text": "Stop, put the man on the jukebox, and then we start to ___\nAnd now I'm singing like", "answer": "dance", "translation_ru": "Стой, поставь ту песню в музыкальном автомате, и мы начнем танцевать."},
            {"file": "sh_4.mp4", "text": "Girl, you know I want your ___\nYour love was handmade for somebody like me", "answer": "love", "translation_ru": "Девочка, ты знаешь, я хочу твоей любви. Твоя любовь была создана для кого-то вроде меня."},
            {"file": "sh_5.mp4", "text": "Come on now, follow my ___\nI may be crazy, don't mind me", "answer": "lead", "translation_ru": "Давай же, следуй за мной. Может я и сумасшедший, не обращай внимания."},
            {"file": "sh_6.mp4", "text": "Say, boy, let's not talk too ___\nGrab on my waist and put that body on me", "answer": "much", "translation_ru": "Скажи: «Парень, давай не будем много болтать. Обхвати мою талию...»"},
            ...
            {"file": "sh_8.mp4", "text": "I'm in love with the shape of ___\nWe push and pull like a magnet do", "answer": "you", "translation_ru": "Я влюблен в твой силуэт. Мы притягиваемся и отталкиваемся как магниты."},
            {"file": "sh_9.mp4", "text": "Although my heart is falling ___\nI'm in love with your body", "answer": "too", "translation_ru": "Хотя мое сердце тоже влюбляется. Я влюблен в твое тело."},
            {"file": "sh_10.mp4", "text": "Last night you were in my ___\nAnd now my bedsheets smell like you", "answer": "room", "translation_ru": "Прошлой ночью ты была в моей комнате. Теперь мои простыни пахнут тобой."},
            ...
            {"file": "sh_13.mp4", "text": "Every day discovering something new\nI'm in love with the ___ of you", "answer": "shape", "translation_ru": "Каждый день открываю что-то новое. Я влюблен в твой силуэт."},
            {"file": "sh_14.mp4", "text": "One week in we let the story ___\nWe're going out on our first date", "answer": "begin", "translation_ru": "Спустя неделю мы даем истории начаться. Мы идем на первое свидание."},
            {"file": "sh_15.mp4", "text": "You and me are thrifty, so go all you can ___\nFill up your bag and I’ll fill up a plate", "answer": "eat", "translation_ru": "Мы с тобой экономные, так что идем туда, где «ешь сколько хочешь»."},
            ...
            {"file": "sh_17.mp4", "text": "Leave and get in a taxi, then kiss in the back ___\nTell the driver make the radio play", "answer": "seat", "translation_ru": "Уходим, садимся в такси, целуемся на заднем сиденье."},
            {"file": "sh_18.mp4", "text": "And I'm singing like\nGirl, you know I want your ___", "answer": "love", "translation_ru": "И я пою: «Девочка, ты знаешь, я хочу твоей любви»."}
        ]
    },
 ]
