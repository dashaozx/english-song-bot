...
SONGS = [
   ...
   "fragments": [
            {"file": "sh_0.mp4", "text": "The club isn't the best place to find a lover\nSo the bar is where I ___", "answer": "go", "translation_ru": "Клуб — не лучшее место для поиска любви, поэтому я иду в бар"},
            {"file": "sh_1.mp4", "text": "Me and my friends at the table doing shots\nDrinking fast and then we talk ___", "answer": "slow", "translation_ru": "Я и мои друзья за столом пьем шоты. Пьем быстро, говорим медленно"},
            {"file": "sh_2.mp4", "text": "And you come over and start up a conversation with just me\nAnd trust me I'll give it a ___ now", "answer": "chance", "translation_ru": "Ты подходишь и заводишь разговор только со мной. Поверь, я дам этому шанс"},
            {"file": "sh_3.mp4", "text": "Take my hand, stop\nPut Van the Man on the ___ and then we start to dance", "answer": "jukebox", "translation_ru": "Возьми меня за руку, стой. Поставь Ван Моррисона в музыкальном автомате, и мы начнем танцевать"},
            {"file": "sh_4.mp4", "text": "Girl, you know I want your love\nYour love was ___ for somebody like me", "answer": "handmade", "translation_ru": "Девочка, ты знаешь, я хочу твоей любви. Твоя любовь создана вручную для кого-то вроде меня"},
            {"file": "sh_5.mp4", "text": "Come on now, follow my lead\nI may be ___, don't mind me", "answer": "crazy", "translation_ru": "Давай же, следуй за мной. Я могу быть сумасшедшим, не обращай внимания"},
            {"file": "sh_6.mp4", "text": "Say, 'Boy, let's not talk too much\nGrab on my ___ and put that body on me'", "answer": "waist", "translation_ru": "Скажи: 'Парень, давай не будем много болтать. Хватай за талию и прижмись ко мне'"},
            {"file": "sh_7.mp4", "text": "Come on now, follow my lead\nCome, come on now, follow my ___'", "answer": "lead", "translation_ru": "Давай же, следуй за мной. Ну же, веди меня"},
            {"file": "sh_8.mp4", "text": "I'm in love with the ___ of you\nWe push and pull like a magnet do", "answer": "shape", "translation_ru": "Я влюблен в твои формы. Мы притягиваемся и отталкиваемся как магниты"},
            {"file": "sh_9.mp4", "text": "Although my heart is ___ too\nI'm in love with your body", "answer": "falling", "translation_ru": "Хотя моё сердце тоже влюбляется. Я влюблен в твое тело"},
            {"file": "sh_10.mp4", "text": "And last night you were in my room\nAnd now my ___ smell like you", "answer": "bedsheets", "translation_ru": "Вчера вечером ты была в моей комнате. И теперь мои простыни пахнут тобой"},
            {"file": "sh_11.mp4", "text": "Every day ___ something brand new\nWell, I'm in love with your body", "answer": "discovering", "translation_ru": "Каждый день открываю что-то совершенно новое. Я влюблен в твое тело"},
            {"file": "sh_12.mp4", "text": "One week in, we let the story begin\nWe're going out on our first ___", "answer": "date", "translation_ru": "Спустя неделю мы позволили истории начаться. Мы идем на наше первое свидание"},
            {"file": "sh_13.mp4", "text": "But you and me are ___, so go all-you-can-eat\nFill up your bag and I fill up a plate", "answer": "thrifty", "translation_ru": "Но мы с тобой экономные, так что идем туда, где 'шведский стол'. Набивай сумку, а я наполню тарелку"},
            {"file": "sh_14.mp4", "text": "We talk for hours and hours about the sweet and the sour\nAnd how your ___ doing okay", "answer": "family", "translation_ru": "Мы болтаем часами о всякой всячине. И о том, что у твоих родных всё хорошо"},
            {"file": "sh_15.mp4", "text": "And leave and get in a taxi\nWe kiss in the ___ seat. Tell the driver make the radio play", "answer": "back", "translation_ru": "Мы уходим и садимся в такси. Целуемся на заднем сиденье. Скажи водителю, пусть включит радио"},
            {"file": "sh_16.mp4", "text": "And I'm singin' like Girl, you know I want your ___\nYour love was handmade for somebody like me", "answer": "love", "translation_ru": "И я пою: 'Девочка, ты знаешь, я хочу твоей любви. Твоя любовь создана для меня'"},
            {"file": "sh_17.mp4", "text": "Come on now, follow my lead\nI may be crazy, don't ___ me", "answer": "mind", "translation_ru": "Давай же, следуй за мной. Я могу быть сумасшедшим, не обращай на меня внимания"},
            {"file": "sh_18.mp4", "text": "Say, 'Boy, let's not talk too much\nGrab on my waist and put that ___ on me'", "answer": "body", "translation_ru": "Скажи: 'Парень, давай не будем много болтать. Хватай за талию и прижмись ко мне'"}
        ]
    },
 ]
